...
The"Name" column contains a hyperlink to the youtube video for that knot, and the "image" column contains the image which can be enlarged by clicking on the image.

Table updated: `r tbl_update_date`

```{r, echo=FALSE}
ties_data %>%
  datatable(escape = FALSE, options = list(dom = 't', ordering = FALSE, autowidth = TRUE, pageLength = nrow(ties_data)), rownames = FALSE, colnames = c('Name', 'No. ties', 'No. steps', 'Fold in half', 'End', 'Shaping difficulty', 'No. loop thrus', 'image'))
