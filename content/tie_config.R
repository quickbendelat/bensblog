...
ties_input_df <- tibble::tribble(
                                 ...
                                 "romance",                    1,        5,         5,              3,                   "Y",           "little",        "https://www.youtube.com/watch?v=XdRsQ3KuTqM",
